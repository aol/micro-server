...
@Microboot @Ignore// Microboot datasources can be done Spring Boot way - test to be changed
public class HibernateRunnerTest {
	...
	public void startServer(){
		...
		server = new MicrobootApp( Config.instance().withEntityScan("app.hibernate.com.aol.micro.server")
