...
public class ModuleDataExtractor {
	...
	public List<FilterData> createFilteredDataList() {
		Map<String,Filter> filterMap = module.getFilters();
	...
	public List<ServletData> createServletDataList() {
		Map<String,Servlet> servletMap = module.getServlets();
