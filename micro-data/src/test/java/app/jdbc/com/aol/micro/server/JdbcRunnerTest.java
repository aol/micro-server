...
import app.spring.data.jpa.com.aol.micro.server.HibernateRunnerTest;
...
public class JdbcRunnerTest {
	...
	public void startServer(){
		...
		server = new MicroserverApp( Config.instance().withEntityScan("app.jdbc.com.aol.micro.server")
														.withClassesArray(JdbcRunnerTest.class)
														.withClassesArray(DataClasses.DATASOURCE_CLASSES.getClasses())
