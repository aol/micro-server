...
public class S3Plugin implements Plugin {
	...
	public PSetX<Class> springClasses() {
		return PSetX.of(S3ManifestComparatorProvider.class, S3Configuration.class, S3ClientProvider.class,
						S3Utils.class, S3TransferManagerProvider.class, DirectoryCleaner.class);
	}
